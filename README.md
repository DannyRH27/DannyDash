...
Next, the store coordinates are set as the origin and the user's coordinates are set as the destination in the Distance Matric API inputs and will return duration and distance. ETA will be calculated by manipulating the returned duration and incrementing it with a DateTime Object. <br/><br/>
