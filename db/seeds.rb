...
store11 = Store.create!(name:'RI XV',address: '2250 23rd St, San Francisco, CA 94107', hours: ['M-F All Day'], description: 'Bib Gourmand. Home cooking with farm-to-table ingredients', status: 1, coordinate: '(37.754590, -122.402080)')
...
# Items
Item.destroy_all
item1 = Item.create!(name: 'Roasted Duck Breast(2)', price: 100.00, store_id: store11.id)
item2 = Item.create!(name: '16oz. A5 Wagyu Ribeye', price: 95.00, store_id: store11.id)
item3 = Item.create!(name: 'Hamachi Nigiri Platter', price: 35.00, store_id: store11.id)
item4 = Item.create!(name: 'Peking Duck', price: 40.00, store_id: store11.id)
item5 = Item.create!(name: 'Dumplings(25)', price: 30.00, store_id: store11.id)
item6 = Item.create!(name: 'Catfish', price: 26.00, store_id: store11.id)
item7 = Item.create!(name: 'Whole Duck', price: 25.00, store_id: store11.id)
item8 = Item.create!(name: 'A5 Wagyu Ribeye', price: 50.00, store_id: store11.id)
...
menu_item5 = MenuItem.create!(menu_id: ri_menu4.id, item_id: item5.id, rank: 5, store_id: store11.id)
menu_item6 = MenuItem.create!(menu_id: ri_menu4.id, item_id: item6.id, rank: 6, store_id: store11.id)
menu_item7 = MenuItem.create!(menu_id: ri_menu4.id, item_id: item7.id, rank: 7, store_id: store11.id)
menu_item8 = MenuItem.create!(menu_id: ri_menu4.id, item_id: item8.id, rank: 8, store_id: store11.id)
